/*
 * 修改了默认的HOSTNAME_VERIFIER方式为ALLOW_ALL_HOSTNAME_VERIFIER，基于httpclient 4.5.2版本修改
 * ====================================================================
...
public class SSLConnectionSocketFactory implements LayeredConnectionSocketFactory {
    ...
    public static HostnameVerifier getDefaultHostnameVerifier() {
        //张磊 return new DefaultHostnameVerifier(PublicSuffixMatcherLoader.getDefault());
