...
public class ExampleServiceBase {
	...
	private void waitForRegistrationWithEureka(EurekaClient eurekaClient) {
		...
		String vipAddress = configInstance.getStringProperty("eureka.secureVipAddress", "sample-registering-service").get();
		InstanceInfo nextServerInfo = null;
		while (nextServerInfo == null) {
			try {
				nextServerInfo = eurekaClient.getNextServerFromEureka(vipAddress, true);
			} catch (Throwable e) {
