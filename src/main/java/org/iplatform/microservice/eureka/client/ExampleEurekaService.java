 ...
 * requests. This example just receives one request and exits once it receives
 * the request after processing it.
 *
 */
public class ExampleEurekaService {
	...
	public static void main(String[] args) {
		...
		ApplicationInfoManager applicationInfoManager = initializeApplicationInfoManager(
				new MyDataCenterInstanceConfig());//new CloudInstanceConfig()
