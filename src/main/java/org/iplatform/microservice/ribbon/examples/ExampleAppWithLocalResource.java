 ...
 *
 */
package org.iplatform.microservice.ribbon.examples;
...
public abstract class ExampleAppWithLocalResource {
    ...
    public final void runApp() throws Exception {
        PackagesResourceConfig resourceConfig = new PackagesResourceConfig("org.iplatform.microservice.ribbon.examples.server");
